...
public struct Datatype<Recur: TermType>: DictionaryLiteralConvertible {
	...
	public func definitions(recur: Recur) -> [Declaration<Recur>.DefinitionType] {
		return constructors[constructors.indices].fold((definitions: [], transform: id)) { (each: (String, Telescope<Recur>), into: ([Declaration<Recur>.DefinitionType], Recur -> Recur)) in
